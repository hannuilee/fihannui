...
FORM ALV_HANDLE_TOOLBAR  USING E_OBJECT TYPE REF TO CL_ALV_EVENT_TOOLBAR_SET
  ...
  "BUTN_TYPE
  "0 - Button (normal) / 버튼(일반)
  "1 - Menu and default button / 메뉴 및 기본 버튼
  "2 - Menu / 메뉴
  "3 - Separator / 분리자
  "4 - Radio button / 라디오 버튼
  "5 - Checkbox / 체크박스
  "6 - Menu option / 메뉴 옵션
