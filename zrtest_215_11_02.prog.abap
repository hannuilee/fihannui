...
*    parent                      =
    repid                       = SY-REPID
    dynnr                       = SY-DYNNR
*    side                        = CL_GUI_DOCKING_CONTAINER=>DOCK_AT_LEFT "클래스에서 =>
*    side                        = GC_DOCKING->DOCK_AT_LEFT               "객체에서 ->
*    side                        = 1 "왼쪽 DOCK_AT_LEFT
*    side                        = 2 "위 DOCK_AT_TOP
    side                        = 4 "아래 DOCK_AT_BOTTOM
*    side                        = 8 "오른쪽 DOCK_AT_RIGHT
    extension                   = 200
*    style                       =
